...
WITH seating_types AS (
    SELECT DISTINCT
        ...
        CASE
            WHEN approved_for_sidewalk_seating = TRUE THEN TRUE
            WHEN approved_for_sidewalk_seating = FALSE THEN FALSE
            ELSE NULL
        END AS approved_for_sidewalk,

        CASE
            WHEN approved_for_roadway_seating = TRUE THEN TRUE
            WHEN approved_for_roadway_seating = FALSE THEN FALSE
            ELSE NULL
